...
> **Note:** This content has moved. See the consolidated prompting guides in [`/docs/guides/prompting/prompting-tips`](/docs/guides/prompting/prompting-tips), [`/docs/guides/prompting/image-to-image`](/docs/guides/prompting/image-to-image), and [`/docs/guides/prompting/text-to-image`](/docs/guides/prompting/text-to-image).
