...
VINCI_MCP_URL=https://tryvinci.com/api/agent/mcp

# Your Vinci API key (from Vinci Dashboard → API)
VINCI_API_KEY=your-vinci-api-key
...
async def get_vinci_tools():
    ...
    api_key = os.getenv("VINCI_API_KEY")

    if not server_url or not api_key:
        raise EnvironmentError("Missing VINCI_MCP_URL or VINCI_API_KEY in environment.")
