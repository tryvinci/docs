...
<Columns cols={2}>
  <Card title="Explore" icon="compass" href="/docs/platform/explore">
    Browse workflows by category and discover tools.
  </Card>
  <Card title="Assets" icon="folder-open" href="/docs/platform/assets">
    Your generated videos, images, and audio in one library.
  </Card>
  <Card title="Services" icon="grid" href="/docs/guides/platform/index">
